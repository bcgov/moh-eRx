...
namespace Health.PharmaNet.Controllers
{
    ...
    [Route("/api/v{version:apiVersion}/PatientService/")]
    [ApiController]
    public class PatientController : ServiceBaseController
    {
        /// <summary>
        ...
        public async Task<ActionResult<DocumentReference>> Patient()
        {
