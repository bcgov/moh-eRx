...
namespace Health.PharmaNet.Controllers
{
    ...
    [Route("/api/v{version:apiVersion}/PractitionerService/")]
    [ApiController]
    public class PractitionerController : ServiceBaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PractitionerController"/> class.
        /// </summary>
        ...
        public async Task<ActionResult<DocumentReference>> Practitioner()
        {
