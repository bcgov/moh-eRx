...
// Review this code, insert your own values.
public class PharmaNetClaim {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String keycloak = "[your keycloak token endpoint]";
        String scope = "openid system/Claim.write system/Claim.read";
        ...
        HttpRequest claimRequest = HttpRequest.newBuilder()
                .uri(URI.create("[your PharmaNet Claim endpoint]"))
